...
@InputType()
class FeedbackCreateNestedManyWithoutPresentationsInput {
...
export { FeedbackCreateNestedManyWithoutPresentationsInput as FeedbackCreateNestedManyWithoutPresentationsInput };
