...
@InputType()
class PresentationCreateNestedManyWithoutBrandInstancesInput {
...
export { PresentationCreateNestedManyWithoutBrandInstancesInput as PresentationCreateNestedManyWithoutBrandInstancesInput };
